...
if (isset($_SESSION['users']) && !empty($_SESSION['users'])) {
  if ($_SESSION['users']['type'] == 'admin') {
        ...
        <tbody>
          ...
          foreach ($getReportings as $getReporting) {
            ...
            <tr>
              ...
              <td scope="col" style="word-break: break-all;"><a href="./assets/actions/delete_reporting_action.php?id=<?= $getReporting_id ?>"><button class="btn btn-danger">Delete</button></a></td>
    ...
    <?php } else {
      ...
      header('location: /Diplome/index.php?error=04015');
      die();
    } ?>
